...
namespace fa21team9finalproject.Controllers
{
    public class SeedController : Controller
    {
        ...
        public async Task<IActionResult> SeedProperties()
        {
            try
            {
                await Seeding.SeedingProperties.SeedProperties(_context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
        ...
        public async Task<IActionResult> SeedCategories()
        {
            try
            {
                await Seeding.SeedingCategories.SeedCategories(_context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
        ...
        public async Task<IActionResult> SeedReviews()
        {
            try
            {
                await Seeding.SeedingReviews.SeedReviews(_context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
        ...
        public async Task<IActionResult> SeedCustomers()
        {
            try
            {
                await Seeding.SeedingCustomer.SeedCustomers(_userManager, _context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
        ...
        // seed hosts
        public async Task<IActionResult> SeedHosts()
        {
            try
            {
                await Seeding.SeedingHosts.SeedHosts(_userManager, _context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
        ...
        public async Task<IActionResult> SeedAdmins()
        {
            try
            {
                await Seeding.SeedingAdmins.SeedAdmins(_userManager, _context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
        ...
        public async Task<IActionResult> SeedPastReservations()
        {
            try
            {
                await Seeding.SeedingPastReservations.SeedPastReservations(_context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
        ...
        public async Task<IActionResult> SeedOrders()
        {
            try
            {
                await Seeding.SeedingOrders.SeedOrders(_context);
            }
            catch (Exception ex)
            {
                //add the error messages to a list of strings
